...
public class DepartmentsController : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromBody] DepartmentCreateDto dto) => this.ToActionResult(await _svc.CreateAsync(dto));

    //[HttpPut("{id:int}")]
    //[Authorize(Roles = "Admin,Staff")]
    //public async Task<IActionResult> Update(int id, [FromBody] DepartmentUpdateDto dto) => this.ToActionResult(await _svc.UpdateAsync(id, dto));
