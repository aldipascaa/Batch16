...
public class AppointmentsController : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromBody] AppointmentCreateDto dto) => this.ToActionResult(await _svc.CreateAsync(dto));

    [HttpPut("{id:int}")]
    [Authorize(Roles = "Admin,Staff")]
    public async Task<IActionResult> Update(int id, [FromBody] AppointmentUpdateDto dto) => this.ToActionResult(await _svc.UpdateAsync(id, dto));
